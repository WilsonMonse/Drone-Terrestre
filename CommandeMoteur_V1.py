...
#* 22 juin 2022 : harmonisation ne snake 
#*
...
def receptionCommande() :
        ...
        print ('Reception...')
        vALUE = client.recv(1024)     # receptio de la commande envoyer par le serveur
        print ('Recu :', vALUE)
